...
namespace ElephantUniTask.Threading.Tasks.Internal
{
    internal static class DiagnosticsExtensions
    {
        ...
        static string BeautifyType(Type t, bool shortName)
        {
            ...
            if (!t.IsGenericType) return shortName ? t.Name : t.FullName.Replace("ElephantUniTask.Threading.Tasks.Triggers.", "").Replace("ElephantUniTask.Threading.Tasks.Internal.", "").Replace("ElephantUniTask.Threading.Tasks.", "") ?? t.Name;
            ...
            return typeBeautifyRegex.Replace(genericType, "").Replace("ElephantUniTask.Threading.Tasks.Triggers.", "").Replace("ElephantUniTask.Threading.Tasks.Internal.", "").Replace("ElephantUniTask.Threading.Tasks.", "") + "<" + innerFormat + ">";
        }
        ...
        static bool IgnoreLine(MethodBase methodInfo)
        {
            ...
            else if (declareType.StartsWith("ElephantUniTask.Threading.Tasks.CompilerServices"))
            {
                return true;
            }
            ...
            else if (declareType.StartsWith("ElephantUniTask.Threading.Tasks.UniTaskCompletionSourceCore"))
            {
                return true;
            }
            else if (declareType.StartsWith("ElephantUniTask.Threading.Tasks.AwaiterActions"))
            {
                return true;
            }
