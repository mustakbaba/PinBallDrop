...
namespace ElephantSDK
{
    ...
    public class BaseData
    {
        ...
        public void FillBaseData(long sessionID)
        {
                ...
                this.elephant_id = ElephantCore.Instance.userId;
                this.consent_status = ElephantCore.Instance.consentStatus;
                this.mirror_data = ElephantCore.Instance.mirrorData ?? new List<MirrorData>();
...
#elif UNITY_IOS
                locale = ElephantIOS.getLocale();
#elif UNITY_ANDROID
                locale = ElephantAndroid.GetLocale();
#else
                locale = CultureInfo.CurrentCulture.Name;
#endif 
                ...
                try
                {
                        ...
                        TimeSpan currentOffset = 
                                TimeZoneInfo.Local.GetUtcOffset( currentDate );
