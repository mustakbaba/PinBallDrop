...
namespace ElephantSocial
{
    public class SocialConst
    {
        ...
        static SocialConst()
        {
            Api = "https://game-server-proxy.rollic.gs/proxy/api/v1";
            var healthcheckEp = "https://game-server-proxy.rollic.gs";
            ...
            ChatEp = "wss://chat-server.rollic.gs/chat_server/api/v1";
        }
    }
}